...
class interactLLM:
    def __init__(self, api_key: str = None, model: str = "gpt-4",
        ...
        # Model mapping for Claude (correct Anthropic model IDs)
        self.claude_model_mapping = {
            "claude-sonnet-4-5": "claude-sonnet-4-5-20250929",    # Sonnet 4.5 (latest)
            "claude-opus-4-5": "claude-opus-4-5-20251101",        # Opus 4.5
            "claude-sonnet-4": "claude-sonnet-4-20250514",        # Sonnet 4
            "claude-3-5-sonnet": "claude-3-5-sonnet-20241022",    # 3.5 Sonnet
            "claude-3-opus": "claude-3-opus-20240229",            # 3 Opus
        }
