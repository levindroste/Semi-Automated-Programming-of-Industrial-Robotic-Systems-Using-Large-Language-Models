"""
Launch file for pick_and_place_test node.

This launch file provides the MoveIt configuration parameters to the test node
...
Usage:
    ...
    Then run this test (simulation only):
        ros2 launch ur10e_hl_interface pick_and_place_test.launch.py

    Or run with real robot:
        ros2 launch ur10e_hl_interface pick_and_place_test.launch.py real_robot:=true
"""
...
def generate_launch_description():
    ...
    moveit_config = MoveItConfigsBuilder(
        "irb120_with_gripper", package_name="ur_with_gripper_moveit_config"
    ).to_moveit_configs()
